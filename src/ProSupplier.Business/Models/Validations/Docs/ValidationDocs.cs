...
namespace ProSupplier.Business.Models.Validations.Docs
{
    public class CpfValidation
    {
        ...
        private static bool TemDigitosValidos(string valor)
        {
            ...
            var digitoVerficador = new DigitoVerificador(number)
                .ComMultiplicadoresDeAte(2, 11)
                .Substituindo("0", 10, 11);
            var firstDigit = digitoVerficador.CalcularDigito();
            digitoVerficador.AddDigito(firstDigit);
            var secondDigit = digitoVerficador.CalcularDigito();
